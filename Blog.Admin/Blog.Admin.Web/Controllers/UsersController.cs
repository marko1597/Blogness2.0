    ...
    public class UsersController : Controller
    {
        ...
        public async Task<ActionResult> Edit(int id)
        {
            try
            {
                ...
                userViewModel.RolesAvailable = GetUserRolesAvailable();
        ...
        private List<UserRoleAvailable> GetUserRolesAvailable()
        {
            var roles = RoleManager.Roles;
            var availableRoles = roles.Select(role => new UserRoleAvailable
            {
                IsSelected = false,
                RoleName = role.Name
            }).ToList();
