...
app.directive('ckeditor', ['$timeout', '$q', function ($timeout, $q) {
    ...
    return {
        ...
        link: function (scope, element, attrs, ctrls) {
            ...
            var onLoad = function () {
                var options = {
                    filebrowserBrowseUrl: attrs.browseUrl,
                    filebrowserUploadUrl: attrs.uploadUrl,
                    filebrowserImageWindowWidth: attrs.imageWindowWidth,
                    filebrowserImageWindowHeight: attrs.imageWindowHeight,
