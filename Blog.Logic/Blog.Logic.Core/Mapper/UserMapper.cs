...
namespace Blog.Logic.Core.Mapper
{
    ...
    {
        public static User ToDto(DataAccess.Database.Entities.Objects.User user)
        {
            if (user != null)
            {
        ...
        public static DataAccess.Database.Entities.Objects.User ToEntity(User user)
        {
            if (user != null)
            {
                var education = user.Education != null
                ...
                return new DataAccess.Database.Entities.Objects.User
                {
                    UserId = user.UserId,
                    UserName = user.UserName,
                    Password = user.Password,
