...
namespace Blog.Logic.Core.Mapper
{
    ...
    {
        public static Comment ToDto(DataAccess.Database.Entities.Objects.Comment comment)
        {
            if (comment != null)
            {
        ...
        public static DataAccess.Database.Entities.Objects.Comment ToEntity(Comment comment)
        {
            if (comment != null)
            {
                var commentLikes = comment.CommentLikes != null
                ...
                return new DataAccess.Database.Entities.Objects.Comment
                {
                    CommentId = comment.CommentId,
                    CommentLikes = commentLikes,
                    CommentLocation = comment.CommentLocation,
